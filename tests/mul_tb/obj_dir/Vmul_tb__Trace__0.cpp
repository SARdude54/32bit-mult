...
void Vmul_tb___024root__trace_chg_0_sub_0(Vmul_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
                      ...
                      [2U])))) {
        bufp->chgIData(oldp+0,(vlSelfRef.mul_tb__DOT__A),32);
        bufp->chgIData(oldp+1,(vlSelfRef.mul_tb__DOT__B),32);
        bufp->chgIData(oldp+2,((vlSelfRef.mul_tb__DOT__A 
                                * vlSelfRef.mul_tb__DOT__B)),32);
        bufp->chgIData(oldp+3,(vlSelfRef.mul_tb__DOT__unnamedblk1__DOT__i),32);
        bufp->chgIData(oldp+4,(vlSelfRef.mul_tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__j),32);
    }
}
